...
鉴于延迟高和稳定性差等原因，不建议通过代理的方式访问Atop API。
...
方法请求地址：即访问服务器地址 `api.a.top`，比如 `api.a.top/trade/api/v1/order`。
...
`https://api.a.top/trade/api/v1/getOrder?accesskey={AccessKey}&market={Market}&nonce={Timestamp}&id={OrderId}&signature={Signature}`
...
nonce | integer | true | N/A | 13位毫秒数 | 
coin | string | true | N/A | 币种名称 | btc,eth,ltc...
address | string | true | N/A | 提现地址 | 仅支持您在Atop的认证地址
